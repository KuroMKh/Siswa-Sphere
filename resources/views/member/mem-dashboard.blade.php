<x-layouts.app :title="__('Member Dashboard')">
    <div class="p-6 max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 dark:text-gray-400">Manage your meetings and track your attendance</p>
        </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-600 dark:text-green-400 mb-1">{{ $meetingAttend }}</p>
                        <p class="text-gray-600 dark:text-gray-300 text-sm">meetings confirmed</p>
                    </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-red-600 dark:text-red-400 mb-1">{{ $meetingAbsent }}</p>
                        <p class="text-gray-600 dark:text-gray-300 text-sm">meetings declined</p>
                    </div>
                ...
                @forelse ($meetings as $meeting)
                    <div
                        ...
                        <div class="flex items-start justify-between mb-3">
                            ...
                            <!-- User Status Badge -->
                            <span
                                class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ml-2 flex-shrink-0
                                                                            @if ($meeting->user_status === 'Attend') bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400
                                                                            @elseif ($meeting->user_status === 'Absent') bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-400
                                                                            @else bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400 @endif">
                                {{ ucfirst($meeting->user_status) }}
                            </span>
                        </div>
                        ...
                        <div class="flex justify-end">
                            <a href="{{ route('member.mem-meetingdetail', $meeting->id) }}"
